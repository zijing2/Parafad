<?php
namespace MGZJ\Helloworld\Controller;
...
class Router implements \Magento\Framework\App\RouterInterface
{
    ...
    {
        $request->setModuleName('helloworld')->setControllerName('test')->setActionName('test');
        /*
...
//         } else if(strpos($identifier, 'helloworld') !== false) {
//             /*
